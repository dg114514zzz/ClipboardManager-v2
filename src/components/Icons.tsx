...
export function StarIcon({ active, size = 15 }: { active?: boolean; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill={active ? "#f0c040" : "none"}
      stroke={active ? "#f0c040" : "#888"}
      strokeWidth="2"
      strokeLinecap="round"
...
export function PinIcon({ active, size = 15 }: { active?: boolean; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill={active ? "#4a9eff" : "none"}
      stroke={active ? "#4a9eff" : "#888"}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    >
...
export function ClipboardOutlineIcon({ size = 40 }: { size?: number }) {
  return (
...
export function LocateIcon({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#888" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
